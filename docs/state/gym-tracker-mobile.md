...
- **#9 привязан к Internal Testers сам** (ручной `tf-attach` не понадобился), установлен на iPhone.
  ...
  **Осталось непроверенным на устройстве:** импорт + iCloud KV (Ф2), камера и скан этикетки (Ф4a).
...
7. [~] **Device-тесты.** ✅ Напоминания (Ф4b) на #7 — прошли, по ним починены 2 дефекта.
   ✅ **Звук rest (Ф1) на #9 — прошёл, принято Вугаром 25.07.** **Остались непроверенными:**
   импорт + iCloud KV (Ф2), камера и скан этикетки (Ф4a).
