...
4. [ ] **Фаза 4b — напоминания** (§2.4) — **отсюда стартует следующая сессия.** Полная разведка и план лежат
   в блоке «Фаза 4b — что выяснено перед стартом». Первое действие: решить с Вугаром развилку (a)/(b) —
   где хранить время приёма. §2.6 уже сделано в Фазе 1, не переделывать.
5. [ ] **Билд после 4b** — закроет разом device-тесты Фазы 1 (звук), 2 (iCloud/импорт) и 4a (камера, скан).
