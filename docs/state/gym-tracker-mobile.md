...
**Фаза 4b (напоминания о добавках) написана, снята в web-UI и запушена (`6d498cf`) — ждёт device-теста.**
...
- Last commit: `6d498cf` (Фаза 4b). Код: Фаза 4a `3cabcd6`, фикс воркера `a1fe987`. Воркер в проде,
