...
**Не проверено пальцем:** конкуренция удержания (180 мс) с вертикальным скроллом; **автоскролла нет** —
у нижнего края экран сам не поедет.
...
- [x] Drag-and-drop reorder в редакторе плана (`12d7d9b`) — ждёт проверки пальцем на билде #10
